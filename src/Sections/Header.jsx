...
const Header = () => {
    ...
    const Navlink = ({ title }) => (
      <LinkScroll onClick={() => setIsOpen(false)} to={title} offset={-100} spy smooth activeClass='nav-active'
    ...
    <header className={clsx('fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4', hasScrolled && 'py-2 bg-black-100 backdrop-blur-[8px]')}>
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2">
          <img
            src="src/public/images/xora.svg"
            width={115}
            height={55}
            alt="Logo"
          />
        ...
        max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before"
          >
            ...
            translate-x-[-290px] -translate-y-1/2 rotate-90">
                <img src="src/public/images/bg-outlines.svg" width={960} height={380} alt="outline"
                className="relative z-2" />
                
                <img src="src/public/images/bg-outlines-fill.png" width={960} height={380} alt="outline"
        ...
        onClick={() => setIsOpen( (prevState) => !prevState)} >
            ...
            <img src={`src/public/images/${isOpen ? 'close' : 'magic'}.svg`} alt="magic" 
