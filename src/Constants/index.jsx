export const features = [
  ...
  export const details = [
    {
      id: '0',
      icon: 'src/public/images/detail-1.png',
      title: 'AI automated video editing',
    },
    {
      id: '1',
      icon: 'src/public/images/detail-2.png',
      title: 'Collaborate with your team',
    },
    {
      id: '2',
      icon: 'src/public/images/detail-3.png',
      title: 'Ultra fast cloud-engine',
    },
    {
      id: '3',
      icon: 'src/public/images/detail-4.png',
  ...
  export const plans = [
    {
      ...
      icon: 'src/public/images/circle.svg',
      logo: 'src/public/images/plan-1.png',
    },
    {
      id: '1',
      title: 'Overdrive',
      ...
      icon: 'src/public/images/triangle.svg',
      logo: 'src/public/images/plan-2.png',
    },
    {
      id: '2',
      title: 'Team',
      ...
      icon: 'src/public/images/hexagon.svg',
      logo: 'src/public/images/plan-3.png',
    },
  ];
  ...
  export const logos = [
    {
      id: '0',
      title: 'Afterpay',
      url: 'src/public/images/logos/afterpay.svg',
      width: 156,
      height: 48,
    },
    {
      id: '1',
      title: 'Amplitude',
      url: 'src/public/images/logos/amplitude.svg',
      width: 194,
      height: 48,
    },
    {
      id: '2',
      title: 'Sonos',
      url: 'src/public/images/logos/sonos.svg',
      width: 115,
      height: 48,
    },
    {
      id: '3',
      title: 'Maze',
      url: 'src/public/images/logos/maze.svg',
      width: 142,
      height: 48,
    },
    {
      id: '4',
      title: 'Drips',
      url: 'src/public/images/logos/drips.svg',
      width: 77,
      height: 48,
    },
  ];
  ...
  export const socials = [
    {
      id: '0',
      title: 'x',
      icon: 'src/public/images/socials/x.svg',
      url: '#',
    },
    {
      id: '1',
      title: 'Threads',
      icon: 'src/public/images/socials/threads.svg',
      url: '#',
    },
    {
      id: '2',
      title: 'Instagram',
      icon: 'src/public/images/socials/instagram.svg',
      url: '#',
    },
    {
      id: '3',
      title: 'Discord',
      icon: 'src/public/images/socials/discord.svg',
      url: '#',
    },
  ];